 ...
 */
export const advertisementSaveApi = (params: any) => Post('/advertisement/save', params)
/**
 * @description 广告位删除
 * @api http://api-center-bigdata.huan.tv/project/577/interface/api/10621
 */
export const advertisementDelApi = (params: any) => Delete(`/advertisement/remove?id=${params}`)
/**
 * @description 广告管理更新
 * @api http://api-center-bigdata.huan.tv/project/577/interface/api/10637
 */
export const advertisementUpdateApi = (params: any) => Put('/advertisement/update', params)
/**
 * @description 广告管理发布
 * @api http://api-center-bigdata.huan.tv/project/577/interface/api/10641
 */
export const advertisementPublishApi = (params: any) => Put('/advertisement/publish', params)
/**
